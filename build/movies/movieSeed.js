        ...
        switch (_e.label) {
            case 0:
                ...
                return [4 /*yield*/, seedData(collectionName, {
                        ...
                        cast: [],
                        genre: "action",
                        plot: "While it may not be obvious to everyone, there are a number of reasons creating random paragraphs can be useful. A few examples of how some people use this generator are listed in the following paragraphs. ",
                        reviews: [{
                                user: "admin",
