...
var loginService_1 = require("./user/loginService");
// NPM dependencies.
var express = require('express'), cors = require('cors'), bodyParser = require('body-parser'), initDB = require('./db').initDB, cookieParser = require('cookie-parser');
