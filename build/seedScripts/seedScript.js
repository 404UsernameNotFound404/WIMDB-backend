    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                db = getDB();
                if (!clearData) return [3 /*break*/, 3];
                return [4 /*yield*/, db.collection(collection).remove({})];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [4 /*yield*/, db.collection(collection).insertOne(data)];
            case 4:
                createdDocument = _a.sent();
                return [2 /*return*/, createdDocument.ops[0]._id];
        }
    });
}); };
